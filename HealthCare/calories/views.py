...
def HomePageView(request):
    ...
    return render(request, 'calories/home.html', context)
...
def select_food(request):
    ...
    return render(request, 'calories/select_food.html', context)
...
def add_food(request):
    ...
    return render(request, 'calories/add_food.html', context)
...
def delete_food(request, pk):
    ...
    return render(request, 'calories/delete_food.html', context)
...
def ProfilePage(request):
    ...
    return render(request, 'calories/profile.html', context)
